...
define root custom entity ZC_Goods_Issue_Form
{
    ...
    key HeadOfDepartment         : abap.char(100); // Head of Department Name
    key Cashier                  : abap.char(100); // Cashier Name
    key Director                 : abap.char(100); // Director Name
    key Department               : abap.char(255); // Department Name
