CLASS zcl_scope_page_space_vannh19 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_SCOPE_PAGE_SPACE_VANNH19 IMPLEMENTATION.
...
* Space template
    ( object = if_aps_bc_scope_change_api=>gc_tadir_object-uist obj_name = 'Z_ERROR_RATE_RP' )

* Page template
    ( object = if_aps_bc_scope_change_api=>gc_tadir_object-uipg obj_name = 'Z_ERROR_RATE_RP' )
    )
