...
@ObjectModel.sapObjectNodeType.name: 'ZTBDG_BTP_THIEU'
@EndUserText.label: 'Bảng đơn giá trừ tiền'
define root view entity ZR_TBDG_BTP_THIEU
  as select from ztb_dg_btp_thieu
