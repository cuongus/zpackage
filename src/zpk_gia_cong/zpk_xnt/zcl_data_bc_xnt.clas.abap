...
*        lr_filters->get_as_tree
        ...
        LOOP AT lr_ranges ASSIGNING FIELD-SYMBOL(<fs_range>).
          LOOP AT <fs_range>-range ASSIGNING FIELD-SYMBOL(<fs_range_pair>).
            if <fs_range_pair>-low = '='.
                <fs_range_pair>-low = ''.
            endif.
          ENDLOOP.
        ENDLOOP.
        REPLACE all OCCURRENCES OF '''=''' IN lv_sql_filter WITH ''''''.
