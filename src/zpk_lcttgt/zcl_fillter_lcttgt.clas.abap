CLASS zcl_fillter_lcttgt DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-DATA:
     "Instance Singleton
     mo_instance      TYPE REF TO zcl_fillter_lcttgt.

    CLASS-METHODS:
      "Contructor khỏi tạo đối tượng
      get_Instance RETURNING VALUE(ro_instance) TYPE REF TO zcl_fillter_lcttgt,
...
CLASS ZCL_FILLTER_LCTTGT IMPLEMENTATION.
