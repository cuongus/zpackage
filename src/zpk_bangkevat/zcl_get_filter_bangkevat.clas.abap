CLASS zcl_get_filter_bangkevat DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-DATA mo_instance TYPE REF TO zcl_get_filter_bangkevat.

    CLASS-METHODS get_instance
      RETURNING VALUE(ro_instance) TYPE REF TO zcl_get_filter_bangkevat.
    ...
    CLASS-METHODS get_fillter_app
      ...
      EXPORTING ir_bukrs        TYPE tt_range
                ...
                ir_invoice_date TYPE tt_range
                ir_docnum       TYPE tt_range
                ir_prctr        TYPE tt_range
                ir_fiscalyear   TYPE tt_range
                ir_symbol       TYPE tt_range
                ir_tax          TYPE tt_range
...
CLASS ZCL_GET_FILTER_BANGKEVAT IMPLEMENTATION.
