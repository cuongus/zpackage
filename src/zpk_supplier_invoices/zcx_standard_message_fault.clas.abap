class ZCX_STANDARD_MESSAGE_FAULT definition
  public
...
public section.
  ...
  data STANDARD type ZEXCHANGE_FAULT_DATA read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZEXCHANGE_FAULT_DATA optional
...
CLASS ZCX_STANDARD_MESSAGE_FAULT IMPLEMENTATION.
