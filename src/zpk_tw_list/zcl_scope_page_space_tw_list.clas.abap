CLASS zcl_scope_page_space_tw_list DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_SCOPE_PAGE_SPACE_TW_LIST IMPLEMENTATION.
...
* Space template
   ( object = if_aps_bc_scope_change_api=>gc_tadir_object-uist obj_name = 'Z_TW_LIST' )

* Page template
    ( object = if_aps_bc_scope_change_api=>gc_tadir_object-uipg obj_name = 'Z_TW_LIST' )
    )
